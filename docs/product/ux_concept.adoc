...
=== Persona 1: Gerhard Großverleiher

[cols="1,3"]
|===
| *Rolle*
| Bibliothekar in einer Hochschul-Bibliothek
...
=== Persona 2: Katarina Kleinverleiher

[cols="1,3"]
|===
| *Rolle*
| Mitglied einer WG und eines studentischen Kulturvereins
